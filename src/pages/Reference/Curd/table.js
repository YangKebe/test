...
class DataTable extends Component {
        ...
        Modal.confirm({
            ...
            onOk() {
                me.props.dispatch({
                    ...
                    payload: {
                        keys: me.state.selectedRowKeys.toString(),
            ...
            onDoubleClick: () => {
                this.props.dispatch({
                    ...
                    payload: {
                        pathname: `${this.props.match}/detail`,
                        detailType: 'modify',
                        record: this.props.data.find(item => item[colConfig.pKey] === record[colConfig.pKey])
                    }
                });
            }
        }
    ...
    render() {
        const { data, pageSize, style } = this.props;
        const rowSelection = {
            ...
            <div>
                <div style={{ marginTop: '15px', marginBottom: '5px' }}>
                    ...
                    <Button  {...btnStyle}
                        ...
                        onClick={() => {
                            this.props.dispatch({
                                type: `${colConfig}/setDetail`,
                                payload: this.state.selectedRows[0]
                            });
                            this.props.btnDetailClick();
                        }}
                    >修改</Button>
